...
full_corr_ax.tofile('D:\\AdolfoAB\\cobas_infinity_3.02\\Output_12052021\\corr_ax_s'+str(sigma)+'_w'+str(w)+'.csv', sep = ',')
full_corr_ay.tofile('D:\\AdolfoAB\\cobas_infinity_3.02\\Output_12052021\\corr_ay_s'+str(sigma)+'_w'+str(w)+'.csv', sep = ',')
full_corr_az.tofile('D:\\AdolfoAB\\cobas_infinity_3.02\\Output_12052021\\corr_az_s'+str(sigma)+'_w'+str(w)+'.csv', sep = ',')
full_lag_ax.tofile('D:\\AdolfoAB\\cobas_infinity_3.02\\Output_12052021\\lag_ax_s'+str(sigma)+'_w'+str(w)+'.csv', sep = ',')
...
sigma = 6
w = 50
path = "D:\\AdolfoAB\\cobas_infinity_3.02\\Output_13052021\\"

filenames = ['8201667_PHAAET_I.Cima_rec21012021_ninho 68_21_S1',
...
full_corr_ax, full_corr_ay, full_corr_az, full_lag_ax = data_manager.load_corr_data(path, sigma, w, len(all_segments))
...
similar_segments_groups = grouper.GroupSimilarEvents(input_segments, full_corr_ax, full_corr_ay, full_corr_az, threshold_ax, threshold_ay, threshold_az)
...
similar_segments_aligned = grouper.AlignSimilarEvents(segments_to_align, full_lag_ax)
...
for segment_group in temp_similar_groups:
    ...
    for segment in segment_group:
        ...
        for segmentdata in all_data:
            if segment.filename == segmentdata.filename:
                segment.setup_acceleration(segmentdata)
